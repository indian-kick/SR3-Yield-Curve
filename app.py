...
st.title("Interactive Eurodollar Futures Rates Visualization")
...
with main_tab:
    ...
    fig_yc.update_layout(
        title=f"ED Curve on {row['DateOnly']}",
        xaxis=dict(
            tickmode='array',
            tickvals=x_numeric,
...
with outright_tab:
    ...
    maturity = st.selectbox("Select ED Contract", maturities, key="outright_select")
